...
class TitleScreen:
    ...
    def update(self, delta_time, keys_pressed):
        if self.start_game_triggered: return
    ...
    def draw(self, surface):
        ...
        hs_text_surface = self.score_font.render(high_score_text,
                                                 True, COLOR_WHITE)
        ...
        self._draw_text_line(surface, "How to play:",
                             self.header_font, COLOR_WHITE, center_x,
                             current_y)
        current_y += 50
        ...
        if self.space_held_duration >= SPACE_HOLD_TARGET_TIME: hold_text = "Starting!"
