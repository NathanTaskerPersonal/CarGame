...
CAR_MAX_SPEED_FORWARD = 5.0  # Player's max forward speed in world units/sec
...
class Car:
    ...
    def draw(self, surface, camera_world_y, world_unit_scale):
        ...
        # Optional Debug Collision Rect (ensure _update_collision_rect_from_image_rect has been called via update_screen_rects)
