...
COLOR_NEW_HIGH_SCORE_CELEBRATION = pygame.Color(
    "springgreen")  # Festive color
...
class GameOverScreen:
    def __init__(self, screen_width, screen_height):
        ...
        self.celebration_font = pygame.font.Font(None,
                                                 52)  # Larger for new high score text
    ...
    def reset(self):
        self.space_held_duration = 0.0
        self.restart_game_triggered = False
        # self.is_new_high_score = False # This should be set fresh each time set_scores is called
